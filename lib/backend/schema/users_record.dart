...
class UsersRecord extends FirestoreRecord {
  ...
  // "orderlista" field.
  List<DocumentReference>? _orderlista;
  List<DocumentReference> get orderlista => _orderlista ?? const [];
  bool hasOrderlista() => _orderlista != null;
  ...
  void _initializeFields() {
    ...
    _orderlista = getDataList(snapshotData['orderlista']);
  }
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        listEquality.equals(e1?.orderlista, e2?.orderlista);
  }
