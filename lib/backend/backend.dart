...
import 'schema/lista_producto_record.dart';
import 'schema/carrito_record.dart';
import 'schema/lista_promociones_record.dart';
...
export 'schema/lista_producto_record.dart';
export 'schema/carrito_record.dart';
export 'schema/lista_promociones_record.dart';
...
/// Functions to query ListaProductoRecords (as a Stream and as a Future).
Future<int> queryListaProductoRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ListaProductoRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ListaProductoRecord>> queryListaProductoRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ListaProductoRecord.collection,
      ListaProductoRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ListaProductoRecord>> queryListaProductoRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ListaPromocionesRecords (as a Stream and as a Future).
Future<int> queryListaPromocionesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ListaPromocionesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ListaPromocionesRecord>> queryListaPromocionesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ListaPromocionesRecord.collection,
      ListaPromocionesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ListaPromocionesRecord>> queryListaPromocionesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
