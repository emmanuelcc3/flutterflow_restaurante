...
import 'lista_producto_model.dart';
export 'lista_producto_model.dart';
...
class _ListaProductoWidgetState extends State<ListaProductoWidget> {
  late ListaProductoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaProductoModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CarritoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarritoRecord> listaProductoCarritoRecordList = snapshot.data!;
        final listaProductoCarritoRecord =
            listaProductoCarritoRecordList.isNotEmpty
                ? listaProductoCarritoRecordList.first
                : null;
              ...
              actions: [
                Visibility(
                  ...
                  child: Container(
                    ...
                    child: Visibility(
                      visible: (listaProductoCarritoRecord?.activado == true) &&
                          (currentUserUid ==
                              listaProductoCarritoRecord?.creado?.id),
                      child: Padding(
                        padding:
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      'DetalleProd',
                                      queryParameters: {
                                        'productoPara': serializeParam(
                                          listViewProductoRecord,
                                          ParamType.Document,
                                        ),
                                      }.withoutNulls,
                                      extra: <String, dynamic>{
                                        'productoPara': listViewProductoRecord,
                                      },
                                    );
                                  },
                                  child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        formatNumber(
                                                          listViewProductoRecord.promocion ==
                                                                  true
                                                              ? listViewProductoRecord
                                                                  .descuento
                                                              : listViewProductoRecord
