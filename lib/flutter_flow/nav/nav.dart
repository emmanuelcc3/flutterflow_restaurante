...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/detalleProd',
          asyncParams: {
            'productoPara': getDoc(['Producto'], ProductoRecord.fromSnapshot),
          },
          builder: (context, params) => DetalleProdWidget(
            productoPara: params.getParam(
              'productoPara',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'Validar',
          path: '/validar',
          builder: (context, params) => const ValidarWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'Ordenes',
          path: '/ordenes',
          builder: (context, params) => const OrdenesWidget(),
        ),
        FFRoute(
          name: 'DetalledeOrden',
          path: '/detalledeOrden',
          ...
          builder: (context, params) => DetalledeOrdenWidget(
            orden: params.getParam(
              'orden',
              ParamType.Document,
            ),
